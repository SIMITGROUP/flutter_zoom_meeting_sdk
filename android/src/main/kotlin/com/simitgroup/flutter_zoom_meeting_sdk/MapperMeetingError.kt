...
object MapperMeetingError {
    private val errorNames = mapOf(
        ...
        MeetingError.MEETING_ERROR_LOCKED to "LOCKED",
        MeetingError.MEETING_ERROR_RESTRICTED to "RESTRICTED",
        MeetingError.MEETING_ERROR_RESTRICTED_JBH to "RESTRICTED_JBH",
        ...
        MeetingError.MEETING_ERROR_DISALLOW_HOST_REGISTER_WEBINAR to "DISALLOW_HOST_REGISTER_WEBINAR",
        MeetingError.MEETING_ERROR_DISALLOW_PANELIST_REGISTER_WEBINAR to "DISALLOW_PANELIST_REGISTER_WEBINAR",
        MeetingError.MEETING_ERROR_HOST_DENY_EMAIL_REGISTER_WEBINAR to "HOST_DENY_EMAIL_REGISTER_WEBINAR",
        MeetingError.MEETING_ERROR_WEBINAR_ENFORCE_LOGIN to "WEBINAR_ENFORCE_LOGIN",
